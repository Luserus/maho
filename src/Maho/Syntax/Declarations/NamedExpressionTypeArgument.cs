...
/// </summary>
internal sealed class NamedExpressionTypeArgument : TypeSyntax
{
    ...
    public NamedExpressionTypeArgument(IdentifierNameExpression expression) => Expression = expression;
}
